...
client.on('message', (channel, tags, message, self) => {
  ...
  if(self) return;
   ...
   if(message.toLowerCase() === 'betting is open for blue vs green. use !bet [amount] [team] to place a wager!') {
    ...
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
       if(message.toLowerCase() === 'betting is open for blue vs purple. use !bet [amount] [team] to place a wager!') {
    ...
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  }
   ...
   if(message.toLowerCase() === 'betting is open for purple vs green. use !bet [amount] [team] to place a wager!') {
    ...
    setTimeout(() => {client.say(channel, `!betf purple`); }, 8000);
  	 ...
  	 if(message.toLowerCase() === 'betting is open for black vs blue. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
   if(message.toLowerCase() === 'betting is open for black vs green. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for black vs yellow. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for black vs white. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for black vs black. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
       if(message.toLowerCase() === 'betting is open for black vs purple. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf purple`); }, 8000);
  }
  
       if(message.toLowerCase() === 'betting is open for black vs brown. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
   ...
   if(message.toLowerCase() === 'betting is open for green vs green. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf green`); }, 8000);
  }
   ...
   if(message.toLowerCase() === 'betting is open for yellow vs green. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf green`); }, 8000);
     ...
     if(message.toLowerCase() === 'betting is open for yellow vs yellow. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf yellow`); }, 8000);
  }
    ...
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  	 ...
  	 if(message.toLowerCase() === 'betting is open for brown vs blue. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  }
  
   if(message.toLowerCase() === 'betting is open for brown vs green. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for brown vs yellow. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for brown vs white. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf white`); }, 8000);
  }
  
     if(message.toLowerCase() === 'betting is open for brown vs black. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf black`); }, 8000);
  }
  
       if(message.toLowerCase() === 'betting is open for brown vs purple. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf purple`); }, 8000);
  }
  
       if(message.toLowerCase() === 'betting is open for brown vs brown. use !bet [amount] [team] to place a wager!') {
    setTimeout(() => {client.say(channel, `!betf brown`); }, 8000);
  }
